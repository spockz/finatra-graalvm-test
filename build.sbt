...
lazy val exampleServerSettings = Seq(
  ...
  libraryDependencies ++= Seq(
    "com.twitter" %% "twitter-server-logback-classic" % "20.4.1" exclude ("io.netty", "netty-tcnative-boringssl-static"),
...
libraryDependencies += "com.twitter" %% "finatra-http" % "20.4.1" exclude ("org.checkerframework", "checker-compat-qual") exclude ("io.netty", "netty-tcnative-boringssl-static")
libraryDependencies += "com.twitter" %% "finatra-httpclient" % "20.4.1" exclude ("org.checkerframework", "checker-compat-qual") exclude ("io.netty", "netty-tcnative-boringssl-static")
